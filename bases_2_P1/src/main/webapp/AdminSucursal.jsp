<%-- 
    Document   : AdminSucursal
    Created on : 5 abr. 2022, 17:50:37
    Author     : Persona
--%>
    ...
    <div class="container mt-4">
        ...
        <div class="row mt-2">
            <form action="operacionesSucursal" method="post">
                <input type="hidden" name="operacion" value="1">
                 ...
                 <input type="text" name="direccionSucursal">
        ...
        <div class="row mt-2">
            <form action="operacionesSucursal" method="post">
               ...
               <label class="label-login" for="username">Eliga la sucursal que quiere eliminar</label> 
        ...
        <div class="row mt-2">
            <form action="operacionesSucursal" method="post">
               ...
               <label class="label-login" for="username">Eliga la sucursal que quiere Modificar</label> 
